...
function MegaTable({offeredCourses, selectedCourses, setSelectedCourses, approved, setApproved}) {
              ...
              <TableRow>
                ...
                <TableRow>
                  ...
                  <TableCell>{
                    ...
                    <TableCell>
                    <Checkbox onChange={e => {e.target.checked ? setApproved(true) : setApproved(false)}} checked={approved ? true : false} />
                    </TableCell>
