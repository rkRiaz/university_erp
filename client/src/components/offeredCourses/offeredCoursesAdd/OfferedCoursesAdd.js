...
function OfferedCoursesAdd() {
    ...
    const submit = e => {
        ...
        axios.post('/api/offered-courses/add', final)
        .then(res => {
                    ...
                    <Grid container item xs={12}>
                        <Grid item xs={12} className="course__inputGroup">
                            <TextField select required
                                ...
                                variant="outlined">
                                    <option value=''>Select semester for offer courses</option>
                                    {
...
export default OfferedCoursesAdd
